  ...
  return (
    <div id='top' className='flex flex-col w-full h-full pr-3'>
      <div
        ref={refHeight}
        key='row1'
        className='flex w-full h-1/2 m-1 flex-nowrap'
      >
        <div
          ref={refWidth}
        ...
        >
          {stream1.length === 0 ? (
            ...
            <ChatBox
              width={width / 3}
              height={height}
              title={stream1[0].user_name}
              chatId={stream1[0].videoId}
              platform={stream1[0].platform}
            />
          )}
          {stream2.length === 0 ? (
            ...
            <ChatBox
              width={width / 3}
              height={height}
              title={stream2[0].user_name}
              chatId={stream2[0].videoId}
          ...
          {stream3.length === 0 ? (
            ...
            <ChatBox
              width={width / 3}
              height={height}
              title={stream3[0].user_name}
              chatId={stream3[0].videoId}
              platform={stream3[0].platform}
            />
          )}
