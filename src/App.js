      ...
      >
        <div className='flex'>
          {activeMenu ? (
            <div
              key='sidebar'
              className='mr-1 p-1 w-[200px] fixed sidebar bg-slate-100 dark:bg-[#1b1b1b]'
            >
              <Sidebar />
            </div>
          ) : (
            <div
              key='sidebar'
              className='mr-0 p-1 w-[50px] bg-slate-100 dark:bg-[#1b1b1b]'
            >
              <Sidebar />
            </div>
          )}
          ...
          <div className='flex w-full h-screen'>
            <div
              key='main'
              className={`flex flex-col w-full content-center items-center bg-slate-100 dark:bg-[#1b1b1b] ${
                activeMenu ? 'md:ml-[200px]' : 'flex'
              }`}
            >
              {activeMenu ? (
                <div
